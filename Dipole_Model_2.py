...
# ============================================================
# PHYSICS: DIPOLE FIELD + RESIDUALS
# ============================================================
...
if __name__ == "__main__":
    ...
    # --------------------------------------------------------
    # GLOBAL MODEL GRID (CARTESIAN + NEC)
    # --------------------------------------------------------

    print("=== CREATING CONTINUOUS GLOBAL MODEL GRID ===")
    ...
    # Convert global model to NEC in nT
    N_grid, E_grid, C_grid = cart_to_nec_grid(B_model_global_nT, lat_grid, lon_grid)

    # --------------------------------------------------------
    # OBSERVED FIELD MAPS (TEST SET, CARTESIAN)
    # --------------------------------------------------------

    print("\n=== GENERATING OBSERVED FIELD MAPS (Test Set, Cartesian) ===")
    ...
    # North (red) and South (blue) dipole poles
    ax.scatter(dip_lon1, dip_lat1,
               color='red', s=60, marker='o', edgecolor='black', linewidth=1,
               transform=ccrs.PlateCarree(), zorder=5)
    ax.scatter(dip_lon2, dip_lat2,
               color='blue', s=60, marker='o', edgecolor='black', linewidth=1,
               transform=ccrs.PlateCarree(), zorder=5)
    plt.show()

    # --------------------------------------------------------
    # OBSERVED & RESIDUALS IN NEC (TEST SET, SCATTERED)
    # --------------------------------------------------------

    print("\n=== CONVERTING TEST FIELDS TO NEC (Observed, Model, Residuals) ===")
    ...
    print("Max residual magnitude (NEC): "
    ...
    # --------------------------------------------------------
    # MODEL FIELD MAPS IN NEC (GLOBAL, CONTINUOUS)
    # --------------------------------------------------------
